import{w as r}from"./KTA_1Rqc.js";import{s as l}from"./CCM_4jRA.js";const t=r([]),n=r(""),o=r(!1);let i=0;const c=1e4;setTimeout(()=>{try{const s=localStorage.getItem("approvals");if(s){const e=JSON.parse(s);Array.isArray(e)&&t.set(e)}t.subscribe(e=>{try{localStorage.setItem("approvals",JSON.stringify(e))}catch(a){console.warn("Failed to store approvals:",a)}})}catch(s){console.warn("Failed to access localStorage for approvals:",s)}},0);async function m(s=!1){if(!s&&Date.now()-i<c)return;o.set(!0);const{data:e,error:a}=await l.from("point_submissions").select(`
      id,
      category,
      description,
      points,
