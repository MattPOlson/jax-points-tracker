import { c as create_ssr_component, a as subscribe, o as onDestroy, v as validate_component, b as add_attribute, e as each, d as escape, t as compute_rest_props, g as spread, h as escape_object, u as escape_attribute_value } from './ssr-CFMHIens.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  $$unsubscribe_page();
  return `${`${!$user ? `<div class="${["login-container svelte-1gzd1p6", ""].join(" ").trim()}">${validate_component(Hero, "Hero").$$render(
    $$result,
    {
      title: "JAX Members Portal",
    ...
    {},
    {}
  )} <div class="${["auth-wrapper svelte-1gzd1p6", ""].join(" ").trim()}">${validate_component(Auth, "Auth").$$render(
    $$result,
    {
      supabaseClient: supabase,
      appearance: {
    ...
    {},
    {}
  )}</div></div>` : ` <div class="redirect-message svelte-1gzd1p6" data-svelte-h="svelte-11tewvd"><p>Redirecting to dashboard...</p></div>`}`}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-YGL4s9K8.js.map
