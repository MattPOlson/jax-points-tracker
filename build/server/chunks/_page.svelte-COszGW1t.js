import { c as create_ssr_component, a as subscribe, o as onDestroy, d as escape, v as validate_component, b as add_attribute, e as each, q as compute_rest_props, g as spread, h as escape_object, t as escape_attribute_value } from './ssr-DUmth7AN.js';
import { s as supabase } from './supabaseClient-D_8i9Ohq.js';
import { ThemeSupa, merge, en, VIEWS, template, generateClassNames } from '@supabase/auth-ui-shared';
import './client-C3KLrhj1.js';
import { u as user } from './user-DyGY3mAP.js';
import { p as page } from './stores-CjFwPvAb.js';
import { l as loadApprovals } from './approvalsStore-A-SAdsVP.js';
import { l as loadCategoryData } from './categoryStore-VMqni9tI.js';
import { l as loadLeaderboard } from './leaderboardStore-6wvoJyX-.js';
import { l as loadMySubmissions } from './mySubmissionsStore-DqnQVy7C.js';
...
const css = {
  code: ".login-container.svelte-1209js9.svelte-1209js9{min-height:100vh;display:flex;flex-direction:column;justify-content:center;align-items:center;background:#f8fafc;padding:2rem}.login-header.svelte-1209js9.svelte-1209js9{text-align:center;margin-bottom:2rem}.login-header.svelte-1209js9 h1.svelte-1209js9{color:#ff3e00;text-transform:uppercase;font-size:3rem;font-weight:100;margin-bottom:0.5rem;line-height:1.1}.login-header.svelte-1209js9 p.svelte-1209js9{font-size:1.1rem;color:#333;margin:0}.auth-wrapper.svelte-1209js9.svelte-1209js9{background:white;border-radius:6px;box-shadow:0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);padding:2rem;width:100%;max-width:400px}.auth-wrapper.mobile.svelte-1209js9.svelte-1209js9{border-radius:6px;padding:1.5rem;max-width:350px}.login-container.mobile.svelte-1209js9.svelte-1209js9{padding:1rem}.login-container.mobile.svelte-1209js9 .login-header h1.svelte-1209js9{font-size:2.5rem}.login-container.mobile.svelte-1209js9 .login-header p.svelte-1209js9{font-size:1rem}.splash-screen.svelte-1209js9.svelte-1209js9{min-height:100vh;display:flex;justify-content:center;align-items:center;background:#f8fafc}.splash-content.svelte-1209js9.svelte-1209js9{text-align:center;color:#333}.splash-content.svelte-1209js9 p.svelte-1209js9{font-size:1.5rem;font-weight:600;margin:1rem 0 0.5rem 0;color:#ff3e00}.splash-content.svelte-1209js9 small.svelte-1209js9{font-size:1rem;opacity:0.7;color:#666}.spinner.svelte-1209js9.svelte-1209js9{width:40px;height:40px;border:4px solid rgba(255, 62, 0, 0.2);border-top:4px solid #ff3e00;border-radius:50%;animation:svelte-1209js9-spin 1s linear infinite;margin:0 auto}@keyframes svelte-1209js9-spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@media(max-width: 480px){.login-container.svelte-1209js9.svelte-1209js9{padding:1rem}.login-header.svelte-1209js9 h1.svelte-1209js9{font-size:2.5rem}.login-header.svelte-1209js9 p.svelte-1209js9{font-size:0.9rem}.auth-wrapper.svelte-1209js9.svelte-1209js9{padding:1.5rem}}@media(min-width: 640px){.login-container.svelte-1209js9.svelte-1209js9{padding:3rem 2rem}.login-header.svelte-1209js9 h1.svelte-1209js9{font-size:4rem}.login-header.svelte-1209js9 p.svelte-1209js9{font-size:1.125rem}.auth-wrapper.svelte-1209js9.svelte-1209js9{padding:2.5rem;max-width:450px}}.redirect-message.svelte-1209js9.svelte-1209js9{min-height:100vh;display:flex;justify-content:center;align-items:center;font-size:1.2rem;color:#666}.supabase-auth-ui_ui-container{width:100%}.supabase-auth-ui_ui-input{width:100%;padding:0.75rem;margin-bottom:1rem;border:2px solid #e5e7eb;border-radius:8px;font-size:1rem;transition:border-color 0.2s}.supabase-auth-ui_ui-input:focus{outline:none;border-color:#2563eb}.supabase-auth-ui_ui-button{width:100%;padding:0.875rem;background-color:#2563eb;color:white;border:none;border-radius:8px;cursor:pointer;font-size:1rem;font-weight:600;transition:background-color 0.2s}.supabase-auth-ui_ui-button:hover{background-color:#1d4ed8}.supabase-auth-ui_ui-label{display:block;margin-bottom:0.5rem;font-weight:600;color:#374151}.supabase-auth-ui_ui-message{margin:1rem 0;padding:0.75rem;border-radius:8px;font-size:0.9rem}.supabase-auth-ui_ui-message.error{background-color:#fef2f2;color:#dc2626;border:1px solid #fecaca}.supabase-auth-ui_ui-message.success{background-color:#f0fdf4;color:#16a34a;border:1px solid #bbf7d0}@media(max-width: 640px){.login-container.svelte-1209js9.svelte-1209js9{padding:1rem}.login-header.svelte-1209js9 h1.svelte-1209js9{font-size:2rem}.auth-wrapper.svelte-1209js9.svelte-1209js9{padding:1.5rem}}",
  map: `{"version":3,"file":"+page.svelte","sources":["+page.svelte"],"sourcesContent":["<script>\\n  import { onMount, onDestroy } from 'svelte';\\n  import { supabase } from '$lib/supabaseClient';\\n  import { Auth } from '@supabase/auth-ui-svelte';\\n  import { ThemeSupa } from '@supabase/auth-ui-shared';\\n  import { goto } from '$app/navigation';\\n  import { user } from '$lib/stores/user';\\n  import { page } from '$app/stores';\\n\\n // import { isLoaded as categoriesLoaded } from '$lib/stores/categoryStore';\\n // import { isLoaded as approvalsLoaded } from '$lib/stores/approvalsStore';\\n\\n  import { loadApprovals } from '$lib/stores/approvalsStore';\\n  import { loadCategoryData } from '$lib/stores/categoryStore';\\n  import { loadLeaderboard } from '$lib/stores/leaderboardStore';\\n  import { loadMySubmissions } from '$lib/stores/mySubmissionsStore';\\n\\n  let subscription;\\n  let splash = false;\\n  let splashTimeout;\\n  let isLoading = false;\\n  let isMobile = false;\\n\\n  // Detect mobile device\\n  onMount(() => {\\n    const checkMobile = () => {\\n      isMobile = window.innerWidth < 768 || /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);\\n    };\\n    \\n    checkMobile();\\n    window.addEventListener('resize', checkMobile);\\n    \\n    return () => {\\n      window.removeEventListener('resize', checkMobile);\\n    };\\n  });\\n\\n  // Load data when user is authenticated and on home page\\n  $: if ($page.url.pathname === '/' && $user?.id && !isLoading) {\\n    loadAllData();\\n  }\\n\\n  async function loadAllData() {\\n    isLoading = true;\\n    try {\\n      await Promise.all([\\n        loadApprovals(true),\\n        loadCategoryData(true),\\n        loadLeaderboard(true), // Fixed typo: was loadleaderboardData\\n        loadMySubmissions(true)\\n      ]);\\n    } catch (error) {\\n      console.error('Error loading dashboard data:', error);\\n    } finally {\\n      isLoading = false;\\n    }\\n  }\\n\\n  function startSplash() {\\n    splash = true;\\n    splashTimeout = setTimeout(() => {\\n      splash = false;\\n    }, 8000); // Reduced from 10s to 8s\\n  }\\n\\n  onMount(() => {\\n    // Check if user is already signed in\\n    const checkSession = async () => {\\n      const { data: { session } } = await supabase.auth.getSession();\\n      if (session?.user) {\\n        user.set(session.user);\\n        // Don't show splash for existing sessions, just navigate\\n        goto('/');\\n      }\\n    };\\n\\n    checkSession();\\n\\n    // Listen for auth state changes\\n    const { data } = supabase.auth.onAuthStateChange((event, session) => {\\n      console.log('Auth state changed:', event, session?.user?.id);\\n      \\n      // Use setTimeout to make auth operations non-blocking for tab switching\\n      setTimeout(() => {\\n        if (event === 'SIGNED_IN' && session?.user) {\\n          user.set(session.user);\\n          startSplash(); // Show splash for new sign-ins\\n          goto('/');\\n        } else if (event === 'SIGNED_OUT') {\\n          user.set(null);\\n          splash = false;\\n          clearTimeout(splashTimeout);\\n        }\\n      }, 0);\\n    });\\n\\n    subscription = data.subscription;\\n\\n    return () => {\\n      if (subscription) subscription.unsubscribe();\\n      clearTimeout(splashTimeout);\\n    };\\n  });\\n\\n  onDestroy(() => {\\n    if (subscription) subscription.unsubscribe();\\n    clearTimeout(splashTimeout);\\n  });\\n<\/script>\\n\\n{#if splash}\\n  <div class=\\"splash-screen\\">\\n    <div class=\\"splash-content\\">\\n      <div class=\\"spinner\\"></div>\\n      <p>Loading your dashboard...</p>\\n      <small>This may take a few moments</small>\\n    </div>\\n  </div>\\n{:else if !$user}\\n  <div class=\\"login-container\\" class:mobile={isMobile}>\\n    <div class=\\"login-header\\">\\n      <h1>🍻 JAX Members Portal</h1>\\n      <p>{isMobile ? 'Sign in to continue' : 'Have Fun Brew Better Beer!'}</p>\\n    </div>\\n    \\n    <div class=\\"auth-wrapper\\" class:mobile={isMobile}>\\n      <Auth\\n        supabaseClient={supabase}\\n        appearance={{ \\n          theme: ThemeSupa,\\n          variables: {\\n            default: {\\n              colors: {\\n                brand: '#2563eb',\\n                brandAccent: '#1d4ed8',\\n              },\\n              space: {\\n                inputPadding: isMobile ? '12px' : '14px',\\n                buttonPadding: isMobile ? '12px 16px' : '14px 20px',\\n              },\\n              fontSizes: {\\n                baseInputSize: isMobile ? '16px' : '14px', // Prevents zoom on iOS\\n                baseButtonSize: isMobile ? '16px' : '16px',\\n              }\\n            }\\n          }\\n        }}\\n        providers={[]}\\n        showLinks={true}\\n        magicLink={true}\\n        view={isMobile ? 'sign_in' : undefined}\\n      />\\n    </div>\\n  </div>\\n{:else}\\n  <!-- User is signed in but not showing splash - redirect to dashboard -->\\n  <div class=\\"redirect-message\\">\\n    <p>Redirecting to dashboard...</p>\\n  </div>\\n{/if}\\n\\n<style>\\n  .login-container {\\n    min-height: 100vh;\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n    background: #f8fafc; /* Match your app's light background */\\n    padding: 2rem;\\n  }\\n\\n  .login-header {\\n    text-align: center;\\n    margin-bottom: 2rem;\\n  }\\n\\n  .login-header h1 {\\n    color: #ff3e00; /* Match your main h1 color */\\n    text-transform: uppercase;\\n    font-size: 3rem;\\n    font-weight: 100;\\n    margin-bottom: 0.5rem;\\n    line-height: 1.1;\\n  }\\n\\n  .login-header p {\\n    font-size: 1.1rem;\\n    color: #333; /* Match your subtitle color */\\n    margin: 0;\\n  }\\n\\n  .auth-wrapper {\\n    background: white;\\n    border-radius: 6px; /* Match your nav-button border radius */\\n    box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);\\n    padding: 2rem;\\n    width: 100%;\\n    max-width: 400px;\\n  }\\n\\n  .auth-wrapper.mobile {\\n    border-radius: 6px;\\n    padding: 1.5rem;\\n    max-width: 350px;\\n  }\\n\\n  .login-container.mobile {\\n    padding: 1rem;\\n  }\\n\\n  .login-container.mobile .login-header h1 {\\n    font-size: 2.5rem;\\n  }\\n\\n  .login-container.mobile .login-header p {\\n    font-size: 1rem;\\n  }\\n\\n  .splash-screen {\\n    min-height: 100vh;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    background: #f8fafc; /* Match your app's background */\\n  }\\n\\n  .splash-content {\\n    text-align: center;\\n    color: #333;\\n  }\\n\\n  .splash-content p {\\n    font-size: 1.5rem;\\n    font-weight: 600;\\n    margin: 1rem 0 0.5rem 0;\\n    color: #ff3e00; /* Match your brand color */\\n  }\\n\\n  .splash-content small {\\n    font-size: 1rem;\\n    opacity: 0.7;\\n    color: #666;\\n  }\\n\\n  .spinner {\\n    width: 40px;\\n    height: 40px;\\n    border: 4px solid rgba(255, 62, 0, 0.2); /* Use your brand color */\\n    border-top: 4px solid #ff3e00;\\n    border-radius: 50%;\\n    animation: spin 1s linear infinite;\\n    margin: 0 auto;\\n  }\\n\\n  @keyframes spin {\\n    0% { transform: rotate(0deg); }\\n    100% { transform: rotate(360deg); }\\n  }\\n\\n  /* Responsive design to match your main page breakpoints */\\n  @media (max-width: 480px) {\\n    .login-container {\\n      padding: 1rem;\\n    }\\n\\n    .login-header h1 {\\n      font-size: 2.5rem; /* Match your main page mobile h1 size */\\n    }\\n\\n    .login-header p {\\n      font-size: 0.9rem;\\n    }\\n\\n    .auth-wrapper {\\n      padding: 1.5rem;\\n    }\\n  }\\n\\n  @media (min-width: 640px) {\\n    .login-container {\\n      padding: 3rem 2rem;\\n    }\\n\\n    .login-header h1 {\\n      font-size: 4rem; /* Match your main page desktop h1 size */\\n    }\\n\\n    .login-header p {\\n      font-size: 1.125rem;\\n    }\\n\\n    .auth-wrapper {\\n      padding: 2.5rem;\\n      max-width: 450px;\\n    }\\n  }\\n\\n  .redirect-message {\\n    min-height: 100vh;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n    font-size: 1.2rem;\\n    color: #666;\\n  }\\n\\n  /* Override Supabase Auth UI styles */\\n  :global(.supabase-auth-ui_ui-container) {\\n    width: 100%;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-input) {\\n    width: 100%;\\n    padding: 0.75rem;\\n    margin-bottom: 1rem;\\n    border: 2px solid #e5e7eb;\\n    border-radius: 8px;\\n    font-size: 1rem;\\n    transition: border-color 0.2s;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-input:focus) {\\n    outline: none;\\n    border-color: #2563eb;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-button) {\\n    width: 100%;\\n    padding: 0.875rem;\\n    background-color: #2563eb;\\n    color: white;\\n    border: none;\\n    border-radius: 8px;\\n    cursor: pointer;\\n    font-size: 1rem;\\n    font-weight: 600;\\n    transition: background-color 0.2s;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-button:hover) {\\n    background-color: #1d4ed8;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-label) {\\n    display: block;\\n    margin-bottom: 0.5rem;\\n    font-weight: 600;\\n    color: #374151;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-message) {\\n    margin: 1rem 0;\\n    padding: 0.75rem;\\n    border-radius: 8px;\\n    font-size: 0.9rem;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-message.error) {\\n    background-color: #fef2f2;\\n    color: #dc2626;\\n    border: 1px solid #fecaca;\\n  }\\n\\n  :global(.supabase-auth-ui_ui-message.success) {\\n    background-color: #f0fdf4;\\n    color: #16a34a;\\n    border: 1px solid #bbf7d0;\\n  }\\n\\n  /* Responsive design */\\n  @media (max-width: 640px) {\\n    .login-container {\\n      padding: 1rem;\\n    }\\n\\n    .login-header h1 {\\n      font-size: 2rem;\\n    }\\n\\n    .auth-wrapper {\\n      padding: 1.5rem;\\n    }\\n  }\\n</style>"],"names":[],"mappings":"AAkKE,8CAAiB,CACf,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,OAAO,CACnB,OAAO,CAAE,IACX,CAEA,2CAAc,CACZ,UAAU,CAAE,MAAM,CAClB,aAAa,CAAE,IACjB,CAEA,4BAAa,CAAC,iBAAG,CACf,KAAK,CAAE,OAAO,CACd,cAAc,CAAE,SAAS,CACzB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,aAAa,CAAE,MAAM,CACrB,WAAW,CAAE,GACf,CAEA,4BAAa,CAAC,gBAAE,CACd,SAAS,CAAE,MAAM,CACjB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CACV,CAEA,2CAAc,CACZ,UAAU,CAAE,KAAK,CACjB,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CACjF,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KACb,CAEA,aAAa,qCAAQ,CACnB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,MAAM,CACf,SAAS,CAAE,KACb,CAEA,gBAAgB,qCAAQ,CACtB,OAAO,CAAE,IACX,CAEA,gBAAgB,sBAAO,CAAC,aAAa,CAAC,iBAAG,CACvC,SAAS,CAAE,MACb,CAEA,gBAAgB,sBAAO,CAAC,aAAa,CAAC,gBAAE,CACtC,SAAS,CAAE,IACb,CAEA,4CAAe,CACb,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,OACd,CAEA,6CAAgB,CACd,UAAU,CAAE,MAAM,CAClB,KAAK,CAAE,IACT,CAEA,8BAAe,CAAC,gBAAE,CAChB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,IAAI,CAAC,CAAC,CAAC,MAAM,CAAC,CAAC,CACvB,KAAK,CAAE,OACT,CAEA,8BAAe,CAAC,oBAAM,CACpB,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,GAAG,CACZ,KAAK,CAAE,IACT,CAEA,sCAAS,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACvC,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC7B,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,mBAAI,CAAC,EAAE,CAAC,MAAM,CAAC,QAAQ,CAClC,MAAM,CAAE,CAAC,CAAC,IACZ,CAEA,WAAW,mBAAK,CACd,EAAG,CAAE,SAAS,CAAE,OAAO,IAAI,CAAG,CAC9B,IAAK,CAAE,SAAS,CAAE,OAAO,MAAM,CAAG,CACpC,CAGA,MAAO,YAAY,KAAK,CAAE,CACxB,8CAAiB,CACf,OAAO,CAAE,IACX,CAEA,4BAAa,CAAC,iBAAG,CACf,SAAS,CAAE,MACb,CAEA,4BAAa,CAAC,gBAAE,CACd,SAAS,CAAE,MACb,CAEA,2CAAc,CACZ,OAAO,CAAE,MACX,CACF,CAEA,MAAO,YAAY,KAAK,CAAE,CACxB,8CAAiB,CACf,OAAO,CAAE,IAAI,CAAC,IAChB,CAEA,4BAAa,CAAC,iBAAG,CACf,SAAS,CAAE,IACb,CAEA,4BAAa,CAAC,gBAAE,CACd,SAAS,CAAE,QACb,CAEA,2CAAc,CACZ,OAAO,CAAE,MAAM,CACf,SAAS,CAAE,KACb,CACF,CAEA,+CAAkB,CAChB,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,MAAM,CACjB,KAAK,CAAE,IACT,CAGQ,8BAAgC,CACtC,KAAK,CAAE,IACT,CAEQ,0BAA4B,CAClC,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,OAAO,CAChB,aAAa,CAAE,IAAI,CACnB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CACzB,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,YAAY,CAAC,IAC3B,CAEQ,gCAAkC,CACxC,OAAO,CAAE,IAAI,CACb,YAAY,CAAE,OAChB,CAEQ,2BAA6B,CACnC,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,QAAQ,CACjB,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,OAAO,CACf,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,gBAAgB,CAAC,IAC/B,CAEQ,iCAAmC,CACzC,gBAAgB,CAAE,OACpB,CAEQ,0BAA4B,CAClC,OAAO,CAAE,KAAK,CACd,aAAa,CAAE,MAAM,CACrB,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,OACT,CAEQ,4BAA8B,CACpC,MAAM,CAAE,IAAI,CAAC,CAAC,CACd,OAAO,CAAE,OAAO,CAChB,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,MACb,CAEQ,kCAAoC,CAC1C,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OACpB,CAEQ,oCAAsC,CAC5C,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,OACpB,CAGA,MAAO,YAAY,KAAK,CAAE,CACxB,8CAAiB,CACf,OAAO,CAAE,IACX,CAEA,4BAAa,CAAC,iBAAG,CACf,SAAS,CAAE,IACb,CAEA,2CAAc,CACZ,OAAO,CAAE,MACX,CACF"}`
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  $$unsubscribe_page();
  return `${`${!$user ? `<div class="${["login-container svelte-1209js9", ""].join(" ").trim()}"><div class="login-header svelte-1209js9"><h1 class="svelte-1209js9" data-svelte-h="svelte-rcqp21">🍻 JAX Members Portal</h1> <p class="svelte-1209js9">${escape("Have Fun Brew Better Beer!")}</p></div> <div class="${["auth-wrapper svelte-1209js9", ""].join(" ").trim()}">${validate_component(Auth, "Auth").$$render(
    $$result,
    {
      supabaseClient: supabase,
      appearance: {
    ...
    {},
    {}
  )}</div></div>` : ` <div class="redirect-message svelte-1209js9" data-svelte-h="svelte-11tewvd"><p>Redirecting to dashboard...</p></div>`}`}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-COszGW1t.js.map
